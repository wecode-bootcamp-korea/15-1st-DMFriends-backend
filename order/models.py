...
class Payment(models.Model):
    ...
    payments_type   = models.ForeignKey('PaymentType',on_delete  = models.CASCADE, default = 0)
    member          = models.ForeignKey('user.Member',on_delete  = models.CASCADE, default = 0)
    payments_status = models.OneToOneField('PaymentStatus', on_delete=models.CASCADE, default = 0)
    class Meta:
        db_table = 'payments'
