...
# PaymentType.objects.bulk_create([a1, a2])

# Address.objects.create(address = '', detail_address = '', default = 0, created_at = 201023)
# Member.objects.create(email = '', nickname = '', privacy_agreement = 1, anonymous = 0, random_number = 0, password = '')

# PaymentType.objects.create(name="N/A")
...
Payment.objects.create(kakao_pay='', virtual_account='', member=member_ins, payment_status=paymentstatus_ins, payment_type=paymenttype_ins)
